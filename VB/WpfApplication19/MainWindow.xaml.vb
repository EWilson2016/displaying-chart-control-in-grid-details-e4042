...
Namespace WpfApplication19
    ...
    Partial Public Class MainWindow
        ...
        Private Sub PopulateEmployees()
            ...
            employees_Renamed(1).Orders.Add(New Order("Supplier 2", Date.Now.AddDays(1), "HDMI Cable", 10))
            employees_Renamed(1).Orders.Add(New Order("Supplier 3", Date.Now.AddDays(1), "Projector", 10))
            employees_Renamed(1).Orders.Add(New Order("Supplier 4", Date.Now.AddDays(1), "Amplifier", 10))
        End Sub
